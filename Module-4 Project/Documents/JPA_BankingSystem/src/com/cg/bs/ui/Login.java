...
import com.cg.bs.entities.*;
import com.cg.bs.exception.BankingException;
import com.cg.bs.service.*;;
...
public class Login {
		...
		do{
			...
			switch(choice)
			{
				...
				case "3": System.out.println("Thank you! Bye.");
						  break;
				default: System.out.println("!! Alert: Invalid Input!");
						 break;
			}		
	...
	public static void forgotPassword(int username) {
		...
		if(db_ans.equals(ans))
		{
			...
			System.out.println("!! Alert: Password has been sent to your registered email-id.");
		}
		else
	...
	{
		String startDate="", endDate=""; int acno = 0;
		...
		List<Transactions> tnx = bSer.detailedStatement(acno,startDate,endDate);
		if(!tnx.isEmpty())
		{
	 ...
	 public static void addAccount() {
		...
		if(aser.chechUser(userId))
		{
			...
			System.out.println("!! Alert: No such User. Please add user to continue.");
	}
	...
	public static void addNewCustomer() 
	{
		...
		System.out.println("Success! New Customer added with Customer ID "+aser.addCustomer(cust));
		
		UserTable ut = new UserTable();
		ut.setLogin_password(login_password);
		ut.setPancard(Pancard);
		ut.setLock_status(lock_status);
		System.out.println("Success! New User added with User ID "+aser.addUser(ut));
	...
	public static void accountmaster(int user_id) 
	{
		...
		System.out.println("Success! New A/c opened with account No. "+aser.addAccount(am));
	...
	public static void Userlogin() 
	{
		...
		for(int i=1; i<=3; i++)
		{
			...
			if(flag == true)
			{
				...
				if(check.equals("o"))
				{
					...
					if(password.equals("sbq500#"))
					{
						...
						{
							System.out.println("!! Alert: Password did not match");
							continue;
						}
						break;
					}
				...
				{
					System.out.println("Oops! Your Account is Locked. Please contact your bank");
					break;
				}
			...
			else
			{
				...
				System.out.println("!!Blocked: 3 wrong attempts. Account is locked.");
				break;
			}
