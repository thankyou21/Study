...
<body>
	...
	<table>
		...
		<f:form action="update.obj" modelAttribute="tdetails">
			You are Updating for Train ID: <f:input path="traineeId" readonly="true"/>
			<tr>
			...
			<tr>
				<td><h3><a href="Operation.jsp" >Cancel Update</a></h3></td>
